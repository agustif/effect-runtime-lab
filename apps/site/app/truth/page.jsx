...
export default function TruthSurfacePage() {
  ...
  const quickjsArtifact = bench?.artifacts?.find((entry) =>
    entry.path.includes("effect-quickjs-host"),
  );
      ...
      <section className="section">
        ...
        <div className="summary-grid">
          ...
          <div className="summary-card">
            ...
            <span className="summary-card-value" style={{ color: "var(--pass)" }}>
              {formatNumber(conformance?.curated?.passed)}
            </span>
          </div>
          <div className="summary-card">
            <span className="summary-card-label">Failed</span>
            <span className="summary-card-value" style={{ color: "var(--fail)" }}>
              {formatNumber(conformance?.curated?.failed)}
            </span>
          </div>
          <div className="summary-card">
        ...
        <div className="grid grid-2">
          <div className="card">
            ...
            <div className="card-content">
              <p>
                <Link href="/runtime/quickjs">QuickJS runtime details</Link>
              </p>
              <p>
                <Link href="/runtime/txiki">txiki.js runtime details</Link>
              </p>
              <p>
