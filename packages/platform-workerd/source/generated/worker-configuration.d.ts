/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./source/generated/worker-configuration.d.ts --config ./wrangler.jsonc` (hash: 20827dd74ad322a335b40bf0077a9aa3)
...
declare namespace Cloudflare {
	...
	interface Env {
		COUNTER: DurableObjectNamespace<import("../../test/worker").CounterDurableObject>;
		WORKFLOW: Workflow<Parameters<import("../../test/worker").ExampleWorkflow['run']>[0]['payload']>;
	}
}
